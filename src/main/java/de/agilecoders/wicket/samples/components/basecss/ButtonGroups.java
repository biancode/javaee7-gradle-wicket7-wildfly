...
public class ButtonGroups extends Section<Void>
{
    ...
    ButtonGroup verticalButtonGroup = new ButtonGroup("verticalButtonGroup", Buttons.Orientation.Vertical)
    {
      ...
      protected List<AbstractLink> newButtons(String buttonMarkupId)
      {
        ...
        return Generics2.newArrayList(
            createIconButton(new Icon(GlyphIconType.alignleft)), createIconButton(new Icon(GlyphIconType.aligncenter)),
  ...
  private AbstractLink createIconButton(Icon icon)
  {
    ...
    BootstrapBookmarkablePageLink<Void> button = new BootstrapBookmarkablePageLink<Void>(
        ButtonList.getButtonMarkupId(), ComponentsPage.class, Buttons.Type.Default);
  ...
  private AbstractLink createButton(final String label)
  {
    ...
    AbstractLink button = new BookmarkablePageLink<Void>(ButtonList.getButtonMarkupId(), ComponentsPage.class)
