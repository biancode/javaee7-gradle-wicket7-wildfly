...
public class IssuesPage extends BasePage
{
  ...
  public IssuesPage(PageParameters parameters)
  {
    ...
    add(new Label("popover", "Popover (hover, top)").add(new PopoverBehavior(
        Model.of("title"), Model.of("content"), new PopoverConfig().withHoverTrigger().withPlacement(
            TooltipConfig.Placement.top))));

    add(new Label("richpopover", "Popover (hover, top)").add(new RichPopoverBehavior(
        Model.of("title"), new PopoverConfig().withHoverTrigger().withPlacement(TooltipConfig.Placement.top))
    {
      ...
      public Component newBodyComponent(String markupId)
      {
        ...
        Label label = new Label(markupId, Model
            .of("<h2>rich content</h2><a href=\"http://wb.agilecoders.de\">Link</a>"));
  ...
  public Form<?> createDatePickerForm(final String markupId)
  {
    ...
    Form<DateBean> form = new Form<DateBean>(markupId, new CompoundPropertyModel<DateBean>(new PropertyModel<DateBean>(
        this, "dateBean")));
    add(form);
  ...
  private static final class ParentNavbar extends Navbar
  {
    ...
    public ParentNavbar(final String componentId)
    {
      ...
      }, ComponentPosition.LEFT), new ImmutableNavbarComponent(new NavbarAjaxLink<String>(Model.of("button group b"))
      {
