...
import com.github.biancode.wicket.WicketApplication;
...
abstract class BasePage extends GenericWebPage<Void>
{
  ...
  public BasePage(final PageParameters parameters)
  {
    ...
    add(new Label("newrelic", Model.of(NewRelic.getBrowserTimingHeader()))
        .setEscapeModelStrings(false).setRenderBodyOnly(true).add(new AttributeModifier("id", "newrelic-rum-header")));
    add(new Label("newrelic-footer", Model.of(NewRelic.getBrowserTimingFooter()))
        .setEscapeModelStrings(false).setRenderBodyOnly(true).add(new AttributeModifier("id", "newrelic-rum-footer")));
  }
  ...
  protected Navbar newNavbar(String markupId)
  {
    ...
    navbar.addComponents(NavbarComponents.transform(
        ...
        new NavbarExternalLink(Model.of("https://github.com/l0rdn1kk0n/wicket-bootstrap"))
            .setLabel(Model.of("Github")).setTarget(BootstrapExternalLink.Target.blank)
            .setIconType(GlyphIconType.export), newAddonsDropDownButton()));
    navbar
        .addComponents(new NavbarText(navbar.newExtraItemId(), "Plain text").position(Navbar.ComponentPosition.RIGHT));
  ...
  private Component newAddonsDropDownButton()
  {
    ...
    return new NavbarDropDownButton(Model.of("Addons"))
    {
      ...
      protected List<AbstractLink> newSubMenuButtons(String buttonMarkupId)
      {
        ...
        subMenu.add(new MenuBookmarkablePageLink<Void>(Javascript.class, Model.of("Javascript"))
            .setIconType(GlyphIconType.refresh));
        subMenu.add(new MenuBookmarkablePageLink<Void>(DatePickerPage.class, Model.of("DatePicker"))
            .setIconType(GlyphIconType.time));
        subMenu.add(new MenuBookmarkablePageLink<Void>(DatetimePickerPage.class, Model.of("DateTimePicker"))
            .setIconType(GlyphIconType.time));
        subMenu.add(new MenuBookmarkablePageLink<Void>(SelectPage.class, Model.of("SelectPicker"))
            .setIconType(GlyphIconType.search));
        subMenu.add(new MenuBookmarkablePageLink<Void>(IssuesPage.class, Model.of("Github Issues"))
            .setIconType(GlyphIconType.book));
        subMenu.add(new MenuBookmarkablePageLink<Void>(ExtensionsPage.class, Model.of("Extensions"))
            .setIconType(GlyphIconType.alignjustify));
        subMenu.add(new MenuBookmarkablePageLink<Void>(ExtensionsBootstrapFileInputPage.class, Model
            .of("Extensions - Bootstrap FileInput")).setIconType(GlyphIconType.alignjustify));
        subMenu.add(new MenuBookmarkablePageLink<Void>(FontAwesomePage.class, Model.of("Font Awesome"))
            .setIconType(GlyphIconType.font));
        subMenu.add(new MenuBookmarkablePageLink<Void>(XEditablePage.class, Model.of("X-Editable"))
            .setIconType(GlyphIconType.pencil));
        subMenu.add(new MenuBookmarkablePageLink<Void>(TooltipValidationPage.class, Model.of("Validation"))
  ...
  public void renderHead(IHeaderResponse response)
  {
    ...
    //     JavaScriptHeaderItem.forReference(ApplicationJavaScript.INSTANCE), "footer-container"));
